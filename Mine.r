...
sim_pureh <- foreach(s = 1:total_seeds, .packages=c("stats")) %dopar% {
  tryCatch({
    ...
    K_h_mine <- exp(-(as.matrix(dist(y_s_orig))^2) / (2*(1.06*sd(y_s_orig)*(n0^(-1/5)))^2)); K_h_mine <- K_h_mine / rowSums(K_h_mine)
    
    run_mine_pureh <- function(rho_val) {
      P <- diag(rho_val)
      ...
      L_h_mine <- K_h_mine %*% W %*% H_orig %*% P
      M_h_lambda <- solve(t(L_h_mine) %*% L_h_mine + lambda_reg * diag(n0)) %*% t(L_h_mine)
      
      compute_psi <- function(theta) {
        U <- -1 * (as.vector(y_s_orig - Phi_orig %*% theta) * Phi_orig)  
        R_h <- K_h_mine %*% (diag(n0) - W %*% H_orig %*% (P %*% P)) %*% U
    ...
    theta_mine_s <- run_mine_pureh(rho_star_final)
    theta_mine_T <- run_mine_pureh(rho_tilde_final)
    theta_mine_H <- run_mine_pureh(rho_hat_final)
    
    metrics_mine_s <- calc_metrics(theta_mine_s)
    metrics_mine_T <- calc_metrics(theta_mine_T)
    metrics_mine_H <- calc_metrics(theta_mine_H)
    ...
    res_df <- data.frame(
      ...
      b0_MINE_s_PureH = theta_mine_s[1], b1_MINE_s_PureH = theta_mine_s[2], b2_MINE_s_PureH = theta_mine_s[3], b3_MINE_s_PureH = theta_mine_s[4],
      b0_MINE_T_PureH = theta_mine_T[1], b1_MINE_T_PureH = theta_mine_T[2], b2_MINE_T_PureH = theta_mine_T[3], b3_MINE_T_PureH = theta_mine_T[4],
      b0_MINE_H_PureH = theta_mine_H[1], b1_MINE_H_PureH = theta_mine_H[2], b2_MINE_H_PureH = theta_mine_H[3], b3_MINE_H_PureH = theta_mine_H[4],
      ...
      MSE_MINE_s_PureH = metrics_mine_s[1], RMSE_MINE_s_PureH = metrics_mine_s[2], MAE_MINE_s_PureH = metrics_mine_s[3],
      MSE_MINE_T_PureH = metrics_mine_T[1], RMSE_MINE_T_PureH = metrics_mine_T[2], MAE_MINE_T_PureH = metrics_mine_T[3],
      MSE_MINE_H_PureH = metrics_mine_H[1], RMSE_MINE_H_PureH = metrics_mine_H[2], MAE_MINE_H_PureH = metrics_mine_H[3]
    )
    list(res = res_df)
...
sim_clip001 <- foreach(s = 1:total_seeds, .packages=c("stats")) %dopar% {
  tryCatch({
    ...
    run_mine_clip <- function(rho_val) {
      P <- diag(rho_val)
      d <- H_orig %*% (P %*% rho_val + (pi_val / (1 - pi_val)) * rho_val)
      d_all <- H_all_orig %*% (P %*% rho_val + (pi_val / (1 - pi_val)) * rho_val)
    ...
    theta_mine_s <- run_mine_clip(rho_star_final); theta_mine_T <- run_mine_clip(rho_tilde_final); theta_mine_H <- run_mine_clip(rho_hat_final)
    ...
    metrics_mine_s <- calc_metrics(theta_mine_s); metrics_mine_T <- calc_metrics(theta_mine_T); metrics_mine_H <- calc_metrics(theta_mine_H)
    
    res_df <- data.frame(
      Seed = s,
      b0_MINE_s_Clip001 = theta_mine_s[1], b1_MINE_s_Clip001 = theta_mine_s[2], b2_MINE_s_Clip001 = theta_mine_s[3], b3_MINE_s_Clip001 = theta_mine_s[4],
      b0_MINE_T_Clip001 = theta_mine_T[1], b1_MINE_T_Clip001 = theta_mine_T[2], b2_MINE_T_Clip001 = theta_mine_T[3], b3_MINE_T_Clip001 = theta_mine_T[4],
      b0_MINE_H_Clip001 = theta_mine_H[1], b1_MINE_H_Clip001 = theta_mine_H[2], b2_MINE_H_Clip001 = theta_mine_H[3], b3_MINE_H_Clip001 = theta_mine_H[4],
      MSE_MINE_s_Clip001 = metrics_mine_s[1], RMSE_MINE_s_Clip001 = metrics_mine_s[2], MAE_MINE_s_Clip001 = metrics_mine_s[3],
      MSE_MINE_T_Clip001 = metrics_mine_T[1], RMSE_MINE_T_Clip001 = metrics_mine_T[2], MAE_MINE_T_Clip001 = metrics_mine_T[3],
      MSE_MINE_H_Clip001 = metrics_mine_H[1], RMSE_MINE_H_Clip001 = metrics_mine_H[2], MAE_MINE_H_Clip001 = metrics_mine_H[3]
    )
    list(res = res_df)
  }, error = function(e) { NULL })
}
...
sim_glm <- foreach(s = 1:total_seeds, .packages=c("stats")) %dopar% {
  tryCatch({
    ...
    theta_mine_s <- run_mine_glm(rho_star_final); theta_mine_T <- run_mine_glm(rho_tilde_final); theta_mine_H <- run_mine_glm(rho_hat_final)
    ...
    res_df <- data.frame(
      Seed = s,
      b0_MINE_s_GLM = theta_mine_s[1], b1_MINE_s_GLM = theta_mine_s[2], b2_MINE_s_GLM = theta_mine_s[3], b3_MINE_s_GLM = theta_mine_s[4],
      b0_MINE_T_GLM = theta_mine_T[1], b1_MINE_T_GLM = theta_mine_T[2], b2_MINE_T_GLM = theta_mine_T[3], b3_MINE_T_GLM = theta_mine_T[4],
      b0_MINE_H_GLM = theta_mine_H[1], b1_MINE_H_GLM = theta_mine_H[2], b2_MINE_H_GLM = theta_mine_H[3], b3_MINE_H_GLM = theta_mine_H[4],
      MSE_MINE_s_GLM = metrics_mine_s[1], RMSE_MINE_s_GLM = metrics_mine_s[2], MAE_MINE_s_GLM = metrics_mine_s[3],
      MSE_MINE_T_GLM = metrics_mine_T[1], RMSE_MINE_T_GLM = metrics_mine_T[2], MAE_MINE_T_GLM = metrics_mine_T[3],
      MSE_MINE_H_GLM = metrics_mine_H[1], RMSE_MINE_H_GLM = metrics_mine_H[2], MAE_MINE_H_GLM = metrics_mine_H[3]
    )
    list(res = res_df)
  }, error = function(e) { NULL })
}
...
models_orig <- c("Naive", "IPW_s", "IPW_T", "IPW_H", "MINE_s_PureH", "MINE_T_PureH", "MINE_H_PureH", "Oracle")
box_names <- rev(c("Naive", "IPW(S)", "IPW(T)", "IPW(H)", "MINE(S)", "MINE(T)", "MINE(H)", "Oracle"))
...
# Clip 0.01 boxplot 
# =====================================================================
base_cols <- grep("MINE", names(results_pureh), invert = TRUE, value = TRUE)
df_clip <- merge(results_pureh[, base_cols], results_clip001, by="Seed")

models_orig <- c("Naive", "IPW_s", "IPW_T", "IPW_H", "MINE_s_Clip001", "MINE_T_Clip001", "MINE_H_Clip001", "Oracle")
box_names <- rev(c("Naive", "IPW(S)", "IPW(T)", "IPW(H)", "MINE(S)", "MINE(T)", "MINE(H)", "Oracle"))
...
models_orig <- c("Naive", "IPW_s", "IPW_T", "IPW_H", "MINE_s_GLM", "MINE_T_GLM", "MINE_H_GLM", "Oracle")
box_names <- rev(c("Naive", "IPW(S)", "IPW(T)", "IPW(H)", "MINE(S)", "MINE(T)", "MINE(H)", "Oracle"))
...
for(i in 0:3) {
  ...
  df_final[[paste0("b", i, "_MINE_H_PureH")]] <- results_pureh[[paste0("b", i, "_MINE_H_PureH")]]
  df_final[[paste0("b", i, "_MINE_H_Clip001")]] <- results_clip001[[paste0("b", i, "_MINE_H_Clip001")]]
  df_final[[paste0("b", i, "_MINE_H_GLM")]] <- results_glm[[paste0("b", i, "_MINE_H_GLM")]]
...
for(m in c("RMSE", "MAE")) {
  ...
  df_final[[paste0(m, "_MINE_H_PureH")]] <- results_pureh[[paste0(m, "_MINE_H_PureH")]]
  df_final[[paste0(m, "_MINE_H_Clip001")]] <- results_clip001[[paste0(m, "_MINE_H_Clip001")]]
  df_final[[paste0(m, "_MINE_H_GLM")]] <- results_glm[[paste0(m, "_MINE_H_GLM")]]
  df_final[[paste0(m, "_Oracle")]] <- results_pureh[[paste0(m, "_Oracle")]]
}

# 2. 플롯
models_orig <- c("Naive", "IPW_H", "MINE_H_PureH", "MINE_H_Clip001", "MINE_H_GLM", "Oracle")
box_names_orig <- c("Naive", "IPW(H)", "MINE(H) Pure", "MINE(H) Clip", "MINE(H) GLM", "Oracle")

# 색상: Naive(빨강) -> IPW(노랑) -> MINE(파랑/초록/보라) -> Oracle(회색)
...
model_names <- c("Naive", "IPW(H)", "MINE(H)_Pure", "MINE(H)_Clip", "MINE(H)_GLM", "Oracle")
...
for(m in metrics) {
  ...
  median_df[m, "MINE(H)_Pure"] <- get_med(results_pureh, paste0(m, "_MINE_H_PureH"))
  median_df[m, "MINE(H)_Clip"] <- get_med(results_clip001, paste0(m, "_MINE_H_Clip001"))
  median_df[m, "MINE(H)_GLM"]  <- get_med(results_glm, paste0(m, "_MINE_H_GLM"))
